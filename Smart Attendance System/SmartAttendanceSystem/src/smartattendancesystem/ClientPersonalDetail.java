...
public class ClientPersonalDetail extends javax.swing.JInternalFrame {
    ...
    public ClientPersonalDetail() {
        ...
        disable(false);
        alstClientPersonal = objDB.getAllStudentDetailList();
        if (alstClientPersonal.size() > 0) {
            StudentDetailBean objBean = (StudentDetailBean) alstClientPersonal.get(count);
    ...
    void add() {
        ...
        txtClientID.setText(String.valueOf(objDB.getMaxStudentId() + 1));
    }
    ...
    public void showUserRecord(StudentDetailBean objBean) {
        ...
        txtClientID.setText(String.valueOf(objBean.getStudId()));
        ...
        txtPan.setText(objBean.getEmail());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (txtClientID.getText().equals("")) {
           ...
           jOptionPane1.showMessageDialog(this, "Address is missing", "ERROR", jOptionPane1.ERROR_MESSAGE);
            ...
            try {
                objBean.setStudId(Integer.parseInt(txtClientID.getText()));
                ...
                objBean.setEmail(txtPan.getText());

                if (addUpdateFlag.equalsIgnoreCase("Add")) {
                    result = objDB.addStudentDetail(objBean);
                    if (result.equals("Added")) {
                        flag = 1;
                        alstClientPersonal = objDB.getAllStudentDetailList();
                        count = alstClientPersonal.size() - 1;
                        StudentDetailBean objBean1 = (StudentDetailBean) alstClientPersonal.get(count);
