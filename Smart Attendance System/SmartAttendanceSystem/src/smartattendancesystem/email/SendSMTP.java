package smartattendancesystem.email;
...
//--[ Create the session and create a new mail message
            Authenticator auth = new SMTPAuthenticator("bhaskart155@gmail.com", "123passw");
            Session mailSession = Session.getInstance(p, auth);
            mailSession.setDebug(true);
            Message msg = new MimeMessage(mailSession);

//--[ Set the FROM, TO, DATE and SUBJECT fields
            msg.setFrom(new InternetAddress("bhaskart155@gmail.com"));
